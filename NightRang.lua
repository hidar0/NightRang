...
send(chat,msg.id_,"\n•تم رفع الملف بنجاح وتفعيل المجموعات\n• ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والنائب مديريه} بنجاح")   
end
...
send(msg.chat_id_, msg.id_,"• عذرا البوت ليس نائب مدير يرجى ترقيتي والمحاوله لاحقا") 
...
send(msg.chat_id_,0, "•عذرا يا ⇠ ["..data.first_name_.."](t.me/SouurceLink)\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'• البوت نائب مدير في القناة \n تم تفعيل الاشتراك الاجباري في \n ايدي القناة ('..data.id_..')\n• معرف القناة ([@'..data.type_.channel_.username_..'])') 
redis:set(bot_id..'add:ch:id',data.id_)
redis:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,'• البوت ليس نائب مدير في القناة يرجى ترقيته نائب مدير ثم اعادة المحاوله ') 
end
return false  
end
end,nil)
...
os.execute('wget https://raw.githubusercontent.com/NightRang/hidar0/main/NightRang.lua')
...
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'*• عذرآ هاذا الامر يخص : النائب مديريه فقط *')
end
...
send(msg.chat_id_, msg.id_,"• عذرآ البوت ليس نائب مدير") 
return false  
end
...
if text == ("مسح النائب مديريه") and Owner(msg) then
redis:del(bot_id.."NightRang:Admin:Group"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "•  تم مسح النائب مديريه في المجموعه")
end
...
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*• اهلا عزيزي \n عذرا الامر يخص - منشئ - مالك اساسي *')
end 
...
send(msg.chat_id_,msg.id_,"•  البوت ليس نائب مدير يرجى ترقيتي !")  
return false  
end 
if data.message_ == "CHAT_ADMIN_REQUIRED" then
...
local yazon = "•  عدد النائب مديريه : "..data.administrator_count_..
...
return false end
if text == 'حذف رد النائب مدير' and Owner(msg) then
local channelchek = https.request('https://fuckyou.fuck/ch/?id='..msg.sender_user_id_)
local chekjoine = JSON.decode(channelchek)
if chekjoine.Ch_Member.Ch_info ~= true then
send(msg.chat_id_, msg.id_,'• عليك الاشتراك بقناة السورس \n • قناة السورس - [@SouurceLink] ') 
...
send(msg.chat_id_, msg.id_,"• تم حذف رد النائب مدير ")
return false end
...
send(msg.chat_id_, msg.id_,"•  عذرا لا استطيع طرد نائب مديرية المجموعه") 
return false  
end
...
if text ==("رفع النائب مديريه") and Owner(msg) then
local channelchek = https.request('https://fuckyou.fuck/ch/?id='..msg.sender_user_id_)
local chekjoine = JSON.decode(channelchek)
if chekjoine.Ch_Member.Ch_info ~= true then
send(msg.chat_id_, msg.id_,'• عليك الاشتراك بقناة السورس \n • قناة السورس - [@SouurceLink] ') 
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"•  لا توجد نائب مديرية ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_,"•  تمت ترقية - "..num2.." من نائب مديرية المجموعه") 
end
end,nil)   
end
if text and text:match("^(.*)$") then
...
if not Admin(msg) then 
send(msg.chat_id_,msg.id_,'اهلا عزيزي \n الامر يخص - النائب مدير - مدير فقط')
return false
end 
local List = {[[
𖡋 𝐔𝐒𝐄 ⌯ #username 𖥲 .
...
send(msg.chat_id_, msg.id_,'• المجموعه عاديه وليست خارقه لا تستطيع تفعيلي يرجى ان تضع سجل رسائل المجموعه ضاهر وليس مخفي ومن بعدها يمكنك رفعي نائب مدير ثم تفعيلي') 
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'• البوت ليس نائب مدير يرجى ترقيتي !') 
